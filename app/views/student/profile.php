    ...
    <main class="profile-card">
        <header class="profile-heading">
            <div>
                ...
                <h1>Student Information<span class="heading-heart" aria-hidden="true">&#9825;</span></h1>
                <p class="subtitle">The details behind the name.</p>
            </div>
            <div class="flower small-flower" aria-hidden="true">&#10047;</div>
        </header>
        <section class="profile-section" aria-labelledby="basics-heading">
            <h2 id="basics-heading"><span aria-hidden="true">01</span> The basics</h2>
            <dl class="details">
                <div class="item"><dt>Student ID</dt><dd><?= htmlspecialchars($student_id) ?></dd></div>
                <div class="item"><dt>Student Name</dt><dd><?= htmlspecialchars($name) ?></dd></div>
                <div class="item"><dt>Course</dt><dd><?= htmlspecialchars($course) ?></dd></div>
                <div class="item"><dt>Year Level</dt><dd><?= htmlspecialchars($year) ?></dd></div>
                <div class="item"><dt>Section</dt><dd><?= htmlspecialchars($section) ?></dd></div>
                <div class="item"><dt>Email</dt><dd><a href="mailto:<?= htmlspecialchars($email) ?>"><?= htmlspecialchars($email) ?></a></dd></div>
            </dl>
        </section>
        <section class="profile-section interests" aria-labelledby="interests-heading">
            <h2 id="interests-heading"><span aria-hidden="true">02</span> Things that make me, me</h2>
            <div class="interest-grid">
                <div class="interest-card"><h3><span aria-hidden="true">&#10022;</span> Skills</h3><p><?= htmlspecialchars($skills) ?></p></div>
                <div class="interest-card"><h3><span aria-hidden="true">&#9825;</span> Hobbies</h3><p><?= htmlspecialchars($hobbies) ?></p></div>
            </div>
            <div class="about-note"><span class="note-heart" aria-hidden="true">&#9825;</span><div><h3>Profile description</h3><p><?= htmlspecialchars($profile) ?></p></div></div>
        </section>
    </main>
